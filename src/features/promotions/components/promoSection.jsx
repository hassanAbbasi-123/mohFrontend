...
import { Menu, X, Search, ShoppingCart, PhoneCall, Heart, User, ChevronDown } from 'lucide-react'
...
export default function HeroBanner() {
  ...
  const { data: cartCount, error: cartError } = useGetCartCountQuery(undefined, {
  ...
  const totalItems = (cartError || !cartCount) ? 0 : (cartCount?.totalItems || 0)
  const cartTotal = (cartError || !cartCount) ? 0 : (cartCount?.cartTotal || 0)
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="hidden lg:flex items-center space-x-2">
                  ...
                  <div>
                    <div className="font-bold text-white text-sm drop-shadow-lg">Hot Line 24/7</div>
                    <div className="text-xs text-green-100 drop-shadow-lg">(+91)96476 24282</div>
                  </div>
                </div>
                ...
                <button 
                  ...
                  className="flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 group relative bg-white/10 backdrop-blur-md text-white hover:bg-white/20"
                >
